...
function autocomplete(input, latInput, lngInput) {
    ...
    dropdown.addListener('place_changed', function () {
        ...
        // if hits enter on the address field, dont submit the form
...
function typeAhead(search) {
    ...
    var searchInput = search.querySelector('input[name="search"]'); // Select input with the name of "search"
    ...
    searchInput.on('keyup', function (e) {
        ...
        if (e.keyCode === 40 && current) {
            ...
            // if press down and there's no current
            next = items[0];
...
heartForms.on('submit', _heart2.default); // because of bling.js we can listan to all without having to loop over each
