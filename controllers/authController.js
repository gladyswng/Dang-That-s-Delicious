...
// A local strategy is going to check if the password has been sent in correctly, using local allows us to see the username and password
...
exports.reset = async (req, res) => {
    const user = await User.findOne({
        ...
        // look for expires greater then now
    })
    if(!user) {
